...
export class NotesService {
  ...
  private isNewDeployment(): boolean {
    return localStorage.getItem("DEPLOYMENT_ID") !== process.env.EXPO_PUBLIC_DEPLOYMENT_ID;
  }
  ...
  private invalidateCache() {
    ...
    localStorage.setItem("DEPLOYMENT_ID", process.env.EXPO_PUBLIC_DEPLOYMENT_ID);
  }
